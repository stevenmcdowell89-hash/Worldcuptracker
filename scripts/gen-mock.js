...
matches.push({
  ...
  highlights: { id: "DjYkkRPqV18", title: "England 2-1 Senegal · Highlights", channel: "FIFA", source: "youtube", v: 3 },
});
...
const snapshot = {
  ...
  dayHighlights: { id: "DjYkkRPqV18", title: "World Cup 2026 · Matchday highlights", channel: "FIFA", date: new Date().toISOString().slice(0, 10), source: "youtube", v: 3 },
};
